...
public class UserService {
	...
	public List<Car> getCars(int userId){
		...
		List<Car> cars = restTemplate.getForObject("http://car-service/car/usuario/"+ userId, List.class);
		return cars;
	}
	
	public List<Bike> getBikes(int userId){
		@SuppressWarnings("unchecked")
		List<Bike> bikes = restTemplate.getForObject("http://bike-service/bike/usuario/"+ userId, List.class);
		return bikes;
	}
